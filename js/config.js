...
export const config = {
    ...
    experience: [
        ...
        {
            role: "Gymnasieingenjör, Mjukvaruutveckling",
            company: "Teknikcollege Stenungsund",
            period: "2020 – 2021",
        },
        {
            role: "Gymnasieexamen, Informations- och mediateknik",
            company: "Nösnäsgymnasiet",
            period: "2017 – 2020",
        },
    ],

    skills: ["AI & ML", ".NET", "TypeScript", "Web accessibility", "Software engineering", "IoT", "Network security"],
